...
## Scope
IN: static questionnaire page, 25 A-E questions, one correct answer per question, 70% passing score, Advancy logo and website-derived visual styling, GitHub Pages deployment.
...
## Validation
Run a syntax check over embedded JavaScript and inspect git diff.
